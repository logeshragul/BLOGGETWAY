...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // Default "B" Icon (Matches index.html)
    const defaultFavicon = 'data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><rect width=%22100%22 height=%22100%22 rx=%2220%22 fill=%22%233b82f6%22/><text x=%2250%22 y=%2270%22 font-family=%22Arial%22 font-size=%2270%22 fill=%22white%22 text-anchor=%22middle%22>B</text></svg>';

    link.href = settings.faviconUrl || defaultFavicon;
